...
const Register = () => {
    ...
    return (
        <div className='h-[calc(100vh-120px)] flex justigy-center items-center'>
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <div className='mt-4'>
                    ...
                    className='w-full flex-wrap gap-1 items-center justify-between
                    bg-secondary hover:bg-blue-500 text-white font-bold py-2 px-4 rounded 
                    focus:outline-none'>
                ...
                <p className='mt-5 text-center text-gray-500 text-sm'>@2025 Book Store. All rights</p>
